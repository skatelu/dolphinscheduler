...
export default {
  ...
  'Single StreamLoad insert Max lines': '最大行数',
  'Single StreamLoad insert Max bytes': '最大字节数',
  Times: '次',
  ...
  'Forced success': '强制成功',
  Millisecond: 'ms: 毫秒',
  'Execution time interval': '执行时间间隔',
  Cancel: '取消',
  'Confirm add': '确认添加',
  ...
  'Place enter loadUrl': '请输入loadUrl:StarRocks FE的地址用于Streamload，可以为多个fe地址，形如fe_ip:fe_http_port。\n' +
    '输入格式为 ["0.0.0.0:38100", "10.123.123.12:38100"]',
