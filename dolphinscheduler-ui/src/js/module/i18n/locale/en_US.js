...
export default {
  ...
  'Single StreamLoad insert Max lines': 'Single StreamLoad insert Max lines',
  'Single StreamLoad insert Max bytes': 'Single StreamLoad insert Max bytes',
  Times: 'Times',
  ...
  'Execution time interval': 'Execution time interval',
  Cancel: 'Cancel',
  ...
  '0 means unlimited by byte': 'KB,0 means unlimited',
  '0 means by default bytes': 'B',
  '0 means unlimited by count': '0 means unlimited',
  '0 means by default': '0 means by default',
